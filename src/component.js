...
Component.prototype.createBuilderHTML = function (target) {
  ...
  remove.addEventListener('click', function (e) {
    const list = this.component.parent.components;
...
function TargetCone() {
  ...
  this.data.push(
    new AttributeValue('Angle', 'angle', 90, 0).setTooltip('The angle of the cone arc in degrees'),
  );
  this.data.push(
    new ListValue('Group', 'group', ['Ally', 'Enemy', 'Both'], 'Enemy').setTooltip(
      'The alignment of targets to get',
...
function ConditionName() {
  ...
  this.data.push(
    new StringValue('Text', 'text', 'text').setTooltip("The text to look for in the target's name"),
  );
}
...
function ConditionSkillLevel(skill) {
  ...
  this.data.push(
    new IntValue('Max Level', 'max-level', 99).setTooltip('The maximum level of the skill needed'),
  );
}
...
function MechanicForgetTargets() {
  ...
  this.data.push(
    new StringValue('Key', 'key', 'key').setTooltip('The unique key the targets were stored under'),
  );
}
...
function MechanicPotion() {
  ...
  this.data.push(new AttributeValue('Tier', 'tier', 1, 0).setTooltip('The strength of the potion'));
  this.data.push(
...
function MechanicTrigger() {
  ...
  // CROUCH
  this.data.push(
    new ListValue('Type', 'type', ['Start Crouching', 'Stop Crouching', 'Both'], 'Start Crouching')
...
function MechanicValueRandom() {
  ...
  this.data.push(new AttributeValue('Min', 'min', 0, 0).setTooltip('The minimum value it can be'));
  this.data.push(new AttributeValue('Max', 'max', 0, 0).setTooltip('The maximum value it can be'));
}
...
function MechanicWolf() {
  ...
  this.data.push(
    new AttributeValue('Duration', 'seconds', 10, 0).setTooltip('How long to summon the wolf for'),
  );
  this.data.push(
