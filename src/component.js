...
// prettier-ignore
const Trigger = {
    BLOCK_BREAK          : { name: 'Block Break',          container: true, constructor: TriggerBlockBreak,        category: 'Block',     premium: true   },
    BLOCK_PLACE          : { name: 'Block Place',          container: true, constructor: TriggerBlockPlace,        category: 'Block',     premium: true   },
    CAST                 : { name: 'Cast',                 container: true, constructor: TriggerCast,              category: 'General'                     },
    CLEANUP              : { name: 'Cleanup',              container: true, constructor: TriggerCleanup,           category: 'API'                         },
    CROUCH               : { name: 'Crouch',               container: true, constructor: TriggerCrouch,            category: 'General'                     },
    DEATH                : { name: 'Death',                container: true, constructor: TriggerDeath,             category: 'General'                     },
    ENVIRONMENT_DAMAGE   : { name: 'Environment Damage',   container: true, constructor: TriggerEnvironmentDamage, category: 'Damage',    premium: true   },
    INITIALIZE           : { name: 'Initialize',           container: true, constructor: TriggerInitialize,        category: 'API'                         },
    KILL                 : { name: 'Kill',                 container: true, constructor: TriggerKill,              category: 'General'                     },
    LAND                 : { name: 'Land',                 container: true, constructor: TriggerLand,              category: 'General'                     },
    LAUNCH               : { name: 'Launch',               container: true, constructor: TriggerLaunch,            category: 'General'                     },
    MOVE                 : { name: 'Move',                 container: true, constructor: TriggerMove,              category: 'General',   premium: true   },
    PHYSICAL_DAMAGE      : { name: 'Physical Damage',      container: true, constructor: TriggerPhysicalDamage,    category: 'Damage'                      },
    SKILL_DAMAGE         : { name: 'Skill Damage',         container: true, constructor: TriggerSkillDamage,       category: 'Damage'                      },
    TOOK_PHYSICAL_DAMAGE : { name: 'Took Physical Damage', container: true, constructor: TriggerTookPhysicalDamage,category: 'Damage'                      },
    TOOK_SKILL_DAMAGE    : { name: 'Took Skill Damage',    container: true, constructor: TriggerTookSkillDamage,   category: 'Damage'                      }
};
...
// prettier-ignore
const Mechanic = {
    ATTRIBUTE:           { name: 'Attribute',           container: false, constructor: MechanicAttribute,          category: 'Stat Modifiers'                     },
    BLOCK:               { name: 'Block',               container: false, constructor: MechanicBlock,              category: 'Effects'                            },
    BUFF:                { name: 'Buff',                container: false, constructor: MechanicBuff,               category: 'Stat Modifiers',      premium: true },
    CANCEL:              { name: 'Cancel',              container: false, constructor: MechanicCancel,             cateogry: 'API'                                },
    CHANNEL:             { name: 'Channel',             container: true,  constructor: MechanicChannel,            category: 'Status'                             },
    CLEANSE:             { name: 'Cleanse',             container: false, constructor: MechanicCleanse,            category: 'Status'                             },
    COMMAND:             { name: 'Command',             container: false, constructor: MechanicCommand,            category: 'API'                                },
    COOLDOWN:            { name: 'Cooldown',            container: false, constructor: MechanicCooldown,           category: 'API'                                },
    DAMAGE:              { name: 'Damage',              container: false, constructor: MechanicDamage,             category: 'Damage'                             },
    DAMAGE_BUFF:         { name: 'Damage Buff',         container: false, constructor: MechanicDamageBuff,         category: 'Stat Modifiers'                     },
    DAMAGE_LORE:         { name: 'Damage Lore',         container: false, constructor: MechanicDamageLore,         category: 'Damage'                             },
    DEFENSE_BUFF:        { name: 'Defense Buff',        container: false, constructor: MechanicDefenseBuff,        category: 'Stat Modifiers'                     },
    DELAY:               { name: 'Delay',               container: true,  constructor: MechanicDelay,              category: 'API'                                },
    DISGUISE:            { name: 'Disguise',            container: false, constructor: MechanicDisguise,           category: 'Effects'                            },
    DURABILITY:          { name: 'Durability',          container: false, constructor: MechanicDurability,         category: 'Item',                premium: true },
    EXPLOSION:           { name: 'Explosion',           container: false, constructor: MechanicExplosion,          category: 'Effects'                            },
    FIRE:                { name: 'Fire',                container: false, constructor: MechanicFire,               category: 'Status Control'                     },
    FLAG:                { name: 'Flag',                container: false, constructor: MechanicFlag,               category: 'Flag'                               },
    FLAG_CLEAR:          { name: 'Flag Clear',          container: false, constructor: MechanicFlagClear,          category: 'Flag'                               },
    FLAG_TOGGLE:         { name: 'Flag Toggle',         container: false, constructor: MechanicFlagToggle,         category: 'Flag'                               },
    FOOD:                { name: 'Food',                container: false, constructor: MechanicFood,               category: 'Resource Management', premium: true },
    FORGET_TARGETS:      { name: 'Forget Targets',      container: false, constructor: MechanicForgetTargets,      category: 'Variable Control',    premium: true },
    HEAL:                { name: 'Heal',                container: false, constructor: MechanicHeal,               category: 'Stat Modifiers'                     },
    HEALTH_SET:          { name: 'Health Set',          container: false, constructor: MechanicHealthSet,          category: 'Stat Modifiers',      premium: true },
    HELD_ITEM:           { name: 'Held Item',           container: false, constructor: MechanicHeldItem,           category: 'Item',                premium: true },
    IMMUNITY:            { name: 'Immunity',            container: false, constructor: MechanicImmunity,           category: 'Stat Modifiers'                     },
    INTERRUPT:           { name: 'Interrupt',           container: false, constructor: MechanicInterrupt,          category: 'Status Control'                     },
    ITEM:                { name: 'Item',                container: false, constructor: MechanicItem,               category: 'API'                                },
    ITEM_PROJECTILE:     { name: 'Item Projectile',     container: true,  constructor: MechanicItemProjectile,     category: 'Projectile'                         },
    ITEM_REMOVE:         { name: 'Item Remove',         container: false, constructor: MechanicItemRemove,         category: 'Item'                               },
    LAUNCH:              { name: 'Launch',              container: false, constructor: MechanicLaunch,             category: 'Movement'                           },
    LIGHTNING:           { name: 'Lightning',           container: false, constructor: MechanicLightning,          category: 'Effects'                            },
    MANA:                { name: 'Mana',                container: false, constructor: MechanicMana,               category: 'Resource Management'                },
    MESSAGE:             { name: 'Message',             container: false, constructor: MechanicMessage,            category: 'API'                                },
    PARTICLE:            { name: 'Particle',            container: false, constructor: MechanicParticle,           category: 'Effects'                            },
    PARTICLE_ANIMATION:  { name: 'Particle Animation',  container: false, constructor: MechanicParticleAnimation,  category: 'Effects'                            },
    PARTICLE_EFFECT:     { name: 'Particle Effect',     container: false, constructor: MechanicParticleEffect,     category: 'Effects',             premium: true },
    CANCEL_EFFECT:       { name: 'Cancel Effect',       container: false, constructor: MechanicCancelEffect,       category: 'Effects',             premium: true },
    PARTICLE_PROJECTILE: { name: 'Particle Projectile', container: true,  constructor: MechanicParticleProjectile, category: 'Projectile'                         },
    PASSIVE:             { name: 'Passive',             container: true,  constructor: MechanicPassive,            category: 'API'                                },
    PERMISSION:          { name: 'Permission',          container: false, constructor: MechanicPermission,         category: 'API'                                },
    POTION:              { name: 'Potion',              container: false, constructor: MechanicPotion,             category: 'Stat Modifiers'                     },
    POTION_PROJECTILE:   { name: 'Potion Projectile',   container: true,  constructor: MechanicPotionProjectile,   category: 'Projectile'                         },
    PROJECTILE:          { name: 'Projectile',          container: true,  constructor: MechanicProjectile,         category: 'Projectile'                         },
    PURGE:               { name: 'Purge',               container: false, constructor: MechanicPurge,              category: 'Status Control'                     },
    PUSH:                { name: 'Push',                container: false, constructor: MechanicPush,               category: 'Movement'                           },
    REMEMBER_TARGETS:    { name: 'Remember Targets',    container: false, constructor: MechanicRememberTargets,    category: 'Variable Control'                   },
    REPEAT:              { name: 'Repeat',              container: true,  constructor: MechanicRepeat,             category: 'API'                                },
    SOUND:               { name: 'Sound',               container: false, constructor: MechanicSound,              category: 'Effects'                            },
    SPEED:               { name: 'Speed',               container: false, constructor: MechanicSpeed,              category: 'Stat Modifiers'                     },
    STATUS:              { name: 'Status',              container: false, constructor: MechanicStatus,             category: 'Status Control'                     },
    TAUNT:               { name: 'Taunt',               container: false, constructor: MechanicTaunt,              category: 'Stat Modifiers'                     },
    TRIGGER:             { name: 'Trigger',             container: true,  constructor: MechanicTrigger,            category: 'API',                 premium: true },
    VALUE_ADD:           { name: 'Value Add',           container: false, constructor: MechanicValueAdd,           category: 'Variable Control'                   },
    VALUE_ATTRIBUTE:     { name: 'Value Attribute',     container: false, constructor: MechanicValueAttribute,     category: 'Variable Control'                   },
    VALUE_COPY:          { name: 'Value Copy',          container: false, constructor: MechanicValueCopy,          category: 'Variable Control',    premium: true },
    VALUE_DISTANCE:      { name: 'Value Distance',      container: false, constructor: MechanicValueDistance,      category: 'Variable Control',    premium: true },
    VALUE_HEALTH:        { name: 'Value Health',        container: false, constructor: MechanicValueHealth,        category: 'Variable Control',    premium: true },
    VALUE_LOCATION:      { name: 'Value Location',      container: false, constructor: MechanicValueLocation,      category: 'Variable Control',                  },
    VALUE_LORE:          { name: 'Value Lore',          container: false, constructor: MechanicValueLore,          category: 'Variable Control',                  },
    VALUE_LORE_SLOT:     { name: 'Value Lore Slot',     container: false, constructor: MechanicValueLoreSlot,      category: 'Variable Control',    premium: true },
    VALUE_MANA:          { name: 'Value Mana',          container: false, constructor: MechanicValueMana,          category: 'Variable Control',    premium: true },
    VALUE_MULTIPLY:      { name: 'Value Multiply',      container: false, constructor: MechanicValueMultiply,      category: 'Variable Control',                  },
    VALUE_PLACEHOLDER:   { name: 'Value Placeholder',   container: false, constructor: MechanicValuePlaceholder,   category: 'Variable Control',    premium: true },
    VALUE_RANDOM:        { name: 'Value Random',        container: false, constructor: MechanicValueRandom,        category: 'Variable Control',                  },
    VALUE_SET:           { name: 'Value Set',           container: false, constructor: MechanicValueSet,           category: 'Variable Control',                  },
    WARP:                { name: 'Warp',                container: false, constructor: MechanicWarp,               category: 'Movement'                           },
    WARP_LOC:            { name: 'Warp Location',       container: false, constructor: MechanicWarpLoc,            category: 'Movement'                           },
    WARP_RANDOM:         { name: 'Warp Random',         container: false, constructor: MechanicWarpRandom,         category: 'Movement'                           },
    WARP_SWAP:           { name: 'Warp Swap',           container: false, constructor: MechanicWarpSwap,           category: 'Movement'                           },
    WARP_TARGET:         { name: 'Warp Target',         container: false, constructor: MechanicWarpTarget,         category: 'Movement'                           },
    WARP_VALUE:          { name: 'Warp Value',          container: false, constructor: MechanicWarpValue,          category: 'Movement'                           },
    WOLF:                { name: 'Wolf',                container: true,  constructor: MechanicWolf,               category: 'API'                                },
    TEST:                { name: 'Test',                container: false, constructor: MechanicTest,               category: 'Misc'                               }
};
